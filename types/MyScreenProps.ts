...
export type MyScreenProps = {
    ...
    UserViewAllCourseScreenProps: NativeStackScreenProps<RootStackParamList, 'UserViewAllCourseScreen'>;
    ...
    UserViewAllEnrollmentScreenProps: NativeStackScreenProps<RootStackParamList, 'UserViewAllEnrollmentScreen'>;
